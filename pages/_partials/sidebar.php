...
function is_active($page) {
  ...
  $uri = str_replace('data-warga', '', $uri);
  if (strpos($uri, $page)) {
    echo 'active';
  }
}
...
<ul class="nav nav-sidebar">
  ...
  <li class="<?php is_active('transaksi'); ?>">
    <a href="../transaksi"><i class="glyphicon glyphicon-credit-card"></i> Data Keuangan</a>
  </li>
</ul>

<ul class="nav nav-sidebar">
  <li class="<?php is_active('berita'); ?>">
    <a href="../berita"><i class="glyphicon glyphicon-bell"></i> Berita</a>
  </li>
